...
print(f"[AgroTiltix] Using device: {DEVICE}")
...
def get_dataloaders(data_dir, batch_size):
    ...
    print(f"[AgroTiltix] Train samples: {len(train_dataset)} | Val samples: {len(val_dataset)}")
    print(f"[AgroTiltix] Classes: {train_dataset.classes}")
